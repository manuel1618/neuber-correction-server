...
class TestIndexRoutes:
    ...
    def test_root_endpoint(self):
        ...
        with TestClient(app) as client:
            ...
            assert "STEEL_S355" in response.text or "AL2024_T3" in response.text
...
class TestMaterialRoutes:
    ...
    def test_add_manual_material_with_hardening_exponent(self):
        """Test adding a manual material with hardening exponent"""
        material_data = {
            "name": "test_manual_steel_with_n",
            "yield_strength": 350.0,
            "sigma_u": 500.0,
            "elastic_mod": 210000.0,
            "eps_u": 0.15,
            "ramberg_osgood_n": 18.5,
            "description": "Test manual steel with hardening exponent",
        }
        ...
        with TestClient(app) as client:
            ...
            data = response.json()
            assert data["message"] == "Material added successfully"
            assert data["material"]["name"] == "test_manual_steel_with_n"
    ...
    def test_add_manual_material_optional_hardening_exponent(self):
        """Test adding a manual material without hardening exponent"""
        material_data = {
            "name": "test_manual_steel_no_n",
            "yield_strength": 350.0,
            "sigma_u": 500.0,
            "elastic_mod": 210000.0,
            "eps_u": 0.15,
            "description": "Test manual steel without hardening exponent",
        }
        ...
        with TestClient(app) as client:
            ...
            data = response.json()
            assert data["message"] == "Material added successfully"
            assert data["material"]["name"] == "test_manual_steel_no_n"
    ...
    def test_add_manual_material_invalid_hardening_exponent(self):
        ...
        material_data = {
            "name": "test_manual_steel_invalid_n",
            "yield_strength": 350.0,
            "sigma_u": 500.0,
            "elastic_mod": 210000.0,
            "eps_u": 0.15,
            "ramberg_osgood_n": -5.0,  # Invalid negative value
            "description": "Test manual steel with invalid hardening exponent",
        }
